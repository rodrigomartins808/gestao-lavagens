        ...
        {activeTab === 'campanhas' && (() => {
          ...
          <div className="animate-fade-in" style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
            ...
            <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap', marginBottom: '0.5rem' }}>
              <button className={`btn ${campaignType === 'almost_there' ? 'btn-primary' : 'btn-outline'}`} onClick={() => { setCampaignType('almost_there'); setCampaignText('Olá {nome}! Notámos que só lhe falta 1 carimbo para ganhar um Vale de Desconto em Serviços Especiais! 🎉 Venha visitar-nos esta semana para completar o seu cartão VIP.'); }}>🎯 Quase Lá! (Falta 1)</button>
