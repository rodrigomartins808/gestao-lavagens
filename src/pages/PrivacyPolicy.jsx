    ...
    <div style={{ minHeight: '100vh', backgroundColor: '#f8fafc', padding: '2rem 1rem' }}>
      <div style={{ maxWidth: '800px', margin: '0 auto', backgroundColor: 'white', borderRadius: '1rem', padding: '3rem', boxShadow: '0 4px 6px -1px rgb(0 0 0 / 0.1)' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'center', marginBottom: '2rem' }}>
          <img src={logo} alt="GarageM" style={{ height: '80px', borderRadius: '12px' }} />
        </div>
        ...
        <div style={{ color: '#334155', lineHeight: '1.7', fontSize: '1.1rem' }}>
          ...
          <ul style={{ paddingLeft: '1.5rem', marginBottom: '1.5rem', listStyleType: 'disc' }}>
            ...
            <li style={{ marginBottom: '0.5rem' }}>Oferta de campanhas de reativação, descontos e avisos relevantes diretamente relacionados com os serviços da GarageM;</li>
          ...
          <p style={{ marginBottom: '1.5rem' }}>A GarageM garante que os seus dados pessoais são para <strong>uso estritamente interno</strong>. Em nenhum momento venderemos, alugaremos ou partilharemos os seus dados com terceiros para fins de marketing externo, cumprindo assim com os requisitos do RGPD.</p>

          <h2 style={{ fontSize: '1.5rem', fontWeight: 'bold', color: '#0f172a', marginTop: '2.5rem', marginBottom: '1rem' }}>4. Segurança dos Dados</h2>
          <p style={{ marginBottom: '1.5rem' }}>Implementámos medidas técnicas robustas para proteger os seus dados pessoais contra a destruição, alteração ou acesso não autorizado.</p>
